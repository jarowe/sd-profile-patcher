...
export default function GlobeEditor({ editorParams, globeRef, globeShaderMaterial, setOverlayParams }) {
  ...
  useEffect(() => {
    ...
    windPhysicsFolder.add(proxy, 'windGravity', 0, 10, 0.1).name('Mouse Gravity').onChange(updateParam('windGravity'));
    ...
    windPhysicsFolder.add(proxy, 'windMaxSpeed', 0.1, 3.0, 0.05).name('Max Speed').onChange(updateParam('windMaxSpeed'));
    ...
    windFluidFolder.add(proxy, 'windSpinInfluence', 0, 2.0, 0.05).name('Spin Coupling').onChange(updateParam('windSpinInfluence'));
    windFluidFolder.add(proxy, 'windTurbulence', 0, 3.0, 0.05).name('Turbulence').onChange(updateParam('windTurbulence'));
    windFluidFolder.add(proxy, 'windVortexStrength', 0, 2.0, 0.05).name('Vortex Shedding').onChange(updateParam('windVortexStrength'));
